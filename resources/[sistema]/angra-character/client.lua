RegisterNetEvent("angra-character:normalSpawn")
RegisterNetEvent("angra-character:characterCreate")
...
AddEventHandler("angra-character:characterCreate",function(pedModelHash)
	doStatus = 1
...
AddEventHandler("angra-character:normalSpawn",function(firstspawn)
...
RegisterNUICallback('cDoneSave',function(data,cb)
	...
	TriggerServerEvent("angra-character:finishedCharacter",currentCharacterMode)
end)
