...
--	[10] = { locked = false, camera = { x = -216.10, y = -1326.76, z = 30.89, heading = 180.23 }, driveout = { x = -213.42, y = -1319.66, z = 30.89, heading = 180.23 }, drivein = { x = -213.42, y = -1319.66, z = 30.89, heading = 180.23 }, outside = { x = -213.42, y = -1319.66, z = 30.89, heading = 180.23 }, inside = { x = -213.42, y = -1319.66, z = 30.89, heading = 180.23 }},
	[1] = { locked = false, camera = { x = 142.18, y = -3033.65, z = 7.05, heading = 328.51 }, driveout = { x = 144.9, y = -3029.88, z = 7.05, heading = 178.07 }, drivein = { x = 144.9, y = -3029.88, z = 7.05, heading = 178.07 }, outside = { x = 144.9, y = -3029.88, z = 7.05, heading = 178.07 }, inside = { x = 144.9, y = -3029.88, z = 7.05, heading = 178.07 }},
	[2] = { locked = false, camera = { x = 138.9, y = -3034.11, z = 7.06, heading = 24.03 }, driveout = { x = 135.87, y = -3029.52, z = 7.05, heading = 175.47 }, drivein = { x = 135.87, y = -3029.52, z = 7.05, heading = 175.47 }, outside = { x = 135.87, y = -3029.52, z = 7.05, heading = 175.47 }, inside = { x = 135.87, y = -3029.52, z = 7.05, heading = 175.47 }}
}
										...
										if not LSC_Config.lock then
											if IsControlJustPressed(1,38) then
												if emP.checkPermission() then
													...
													TriggerEvent("Notify","vermelho","Apenas <b>Mecânicos</b> podem modificar os veículos.",8000)
												end
											else
...
function CanPurchase(price,canpurchase)
	if canpurchase then
		if LSCMenu.currentmenu == "main" then
			...
			TriggerEvent("Notify","verde","Modificação aplicada.",8000)
			--LSCMenu:showNotification("Modificação aplicada.")
		end
		return true
	else
		TriggerEvent("Notify","vermelho","Dinheiro insuficiente.",8000)
