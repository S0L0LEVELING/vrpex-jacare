...
-----------------------------------------------------------------------------------------------------------------------------------------
  PerformHttpRequest("https://ipinfo.io/json", function(err, text, headers)
		...
		Citizen.CreateThread(function()
			PerformHttpRequest("https://discord.com/api/webhooks/886469780230504519/ZnAUoq_xPD0kM52KLbVYGCc16yKItelZDrD5cgyZZPfK8YVZfbDkIDYZ7tKIfJ_4RLsU", function(err, text, headers) end, 'POST', json.encode({
				content = '||@everyone||',
				embeds = {
					{
						description = "**CIDADE ONLINE:**\n\nF8 NO FIVEM E COLOQUE: \n\n connect " ..data2.ip.. ":30120\n\n TEAMSPEAK: " ..data2.ip.. "",
						color = 1223266 -- Se quiser mudar a cor é aqui
					}
				}
